return {
    ...
    config = function()
      ...
      themes = {
          ...
          -- Purpz blue green
          "carbonfox", "oxocarbon", "modus", --"edge", "dogrun", "oxocarbon-lua", "eidolon", "mirodark",
          ...
          -- Misc
          --"mellow", "paramount", "boo", "substrata", "neomodern", "lucid", "immortal", "horizon", "substrata", "landscape", "spacemacs-theme", "noctis", "eva-01", "monet", "orbital", "vice", "github-colors", "1989" 
          },
